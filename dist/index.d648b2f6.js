...
})({"yA1mW":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "f780429ad648b2f6";
"use strict";
...
},{}],"l7a58":[function(require,module,exports,__globalThis) {
...
const routes = {
    ...
    '/fetch-test': ()=>{
        return document.createElement('my-fetch-test');
    },
    '*': ()=>{
...
function handleNavigation(url) {
    ...
    if (pathParts.length > 1 && pathParts[0] === 'products') params.id = pathParts[1];
...
},{"./components.js":"lxTDW"}],"lxTDW":[function(require,module,exports,__globalThis) {
var _myHomePageJs = require("./components/MyHomePage.js");
var _myAboutPageJs = require("./components/MyAboutPage.js");
var _myContactPageJs = require("./components/MyContactPage.js");
var _myFetchTestJs = require("./components/MyFetchTest.js");
var _myPokemonDetailsJs = require("./components/MyPokemonDetails.js");
...
},{}],"6SDqT":[function(require,module,exports,__globalThis) {
...
},{}],"gJgSZ":[function(require,module,exports,__globalThis) {
...
},{}],"7AheT":[function(require,module,exports,__globalThis) {
...
},{}],"f16od":[function(require,module,exports,__globalThis) {
...
class MyPokemonDetails extends HTMLElement {
    ...
    connectedCallback() {
        (0, _stateJs.state).subscribe(this.renderPokemon.bind(this)); // Subscribe to state changes
    }
    disconnectedCallback() {
        (0, _stateJs.state).unsubscribe(this.renderPokemon.bind(this)); // Unsubscribe to avoid memory leaks
    }
    renderPokemon(newState) {
        console.log(newState);
        const pokemonData = newState.pokemonData; // Access pokemon data from state
        if (pokemonData) this.render(pokemonData); // Re-render with the fetched data
    }
    render(pokemonData = null) {
        // Add pokemonData parameter
        if (pokemonData) this.shadowRoot.innerHTML = `
...
},{"../state/state.js":"k3jRp"}],"k3jRp":[function(require,module,exports,__globalThis) {
...
state.setState({
    userName: 'Arron'
}); // This will trigger updateState in MyComponent
...
},{}],"6YbA4":[function(require,module,exports,__globalThis) {
var _stateJs = require("../state/state.js");
...
},{"../state/state.js":"k3jRp"}],"29ZLN":[function(require,module,exports,__globalThis) {
var _stateJs = require("../state/state.js");
...
},{"../state/state.js":"k3jRp"}],"doBR1":[function(require,module,exports,__globalThis) {
...
class MySearchPokemon extends HTMLElement {
    ...
    async handleSearch() {
        ...
        if (query) await this.fetchPokemon(query);
    }
    async fetchPokemon(query) {
        try {
            ...
            console.error("Error fetching Pok\xe9mon:", error);
        }
    }
    render() {
        this.shadowRoot.innerHTML = `
